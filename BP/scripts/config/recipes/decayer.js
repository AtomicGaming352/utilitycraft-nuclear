 ...
 */
export const decayerRecipes = {}

const decayerRecipesRegister = {
    // ========== URANIUM ==========
    "utilitycraft:ryno_refined_uranium": { output: "utilitycraft:ryno_plutonium_ingot", amount: 1, cost 3200 },}
...
system.afterEvents.scriptEventReceive.subscribe(({ id, message }) => {
    if (id !== "utilitycraft:register_decayer_recipe") return;
